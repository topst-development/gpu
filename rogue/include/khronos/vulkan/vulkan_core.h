...
typedef enum VkStructureType {
    ...
    VK_STRUCTURE_TYPE_CONDITIONAL_RENDERING_COMPARISON_INFO_IMG = 1234567890,
...
#define VK_IMG_conditional_rendering_comparison_info 1
#define VK_IMG_CONDITIONAL_RENDERING_COMPARISON_INFO_SPEC_VERSION 1
#define VK_IMG_CONDITIONAL_RENDERING_COMPARISON_INFO_EXTENSION_NAME "VK_IMG_conditional_rendering_comparison_info"

typedef struct VkConditionalRenderingComparisonInfoIMG {
	VkStructureType    sType;
	void*              pNext;
	VkCompareOp        compareOp;
	uint32_t           reference;
} VkConditionalRenderingComparisonInfoIMG;
